      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            ...
            buying and selling or services over the internet. It serves as a
            ...
            gained immense popularity due to their convenience, assessibility,
            and the global reach they offer.
          </p>
          <p>
            E-commerce website typically displays products or services along
            with detailed information like price, description, size, color
            options, and images, allowing customers to browse and make informed
            purchasing decisions before adding items to their cart.
          </p>
        </div>
      </div>
